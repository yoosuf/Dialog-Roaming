...
@section('main')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Partner Service/New</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    {{ Form::open(['route' => 'partner-services.store', 'files' => true]) }}
                    @else
                        {{ Form::open(['route' => ['partners.categories.services.store', $partner->id, $category->id ], 'files' => true]) }}
                    @endif
