...
@section('main')
    ...
    <section class="content-header">
        <h1>
            Support Managements / Edit
            <small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active">Support Managements/Edit</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    {{ Form::model($data, ['method' => 'PATCH', 'route' => ['support-managements.update', $data->id]]) }}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::checkbox('is_active', '1', Input::old('is_active', $data->is_active)) }}
